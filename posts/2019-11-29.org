...
/Phys.org/ -- Experimental evidence that quantum reality is not a very well defined thing. In fact  the ability to reconcile two observers interpretation of their experimental results is not  granted by quantum mechanics. But it can be used as a way to detec when quantum mechanics actually become classical.
...
** Researchers reach milestone in quantum standardization -- [[https://eurekalert.org/pub_releases/2019-11/uow-rr112519.php][source]]
...
** France's GDR Quantum Information from Fundamental Aspects to Experiments organized its 10th annual colloqium early november -- [[https://iqfacolloq2019.sciencesconf.org/data/pages/BoA_iqfacolloq2019_CNRS_4.pdf][source]]
...
/Cambridge Quantum Computing/ -- That's a new software for designing / compiling circuits into an efficient representation suitable for being run on the major backends. This is important as these backends have topologies that make various optimizations required to get something useful. 
