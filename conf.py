...
BLOG_TITLE = "Qoherences"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://h-oll.github.io/qoherences/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://h-oll.github.io/qoherences/"
BLOG_EMAIL = "harold.ollivier@linksights.io"
BLOG_DESCRIPTION = "News for quantum people"  # (translatable)
...
THEME = "bnw" #"material-theme" #"bootblog4"
